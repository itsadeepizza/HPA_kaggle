...
class RoIHeads(torch.nn.Module):
    ...
    def postprocess_detections(self,
        ...
        for boxes, scores, image_shape in zip(pred_boxes_list, pred_scores_list, image_shapes):
            ...
            boxes, scores, labels, logits = boxes[keep], scores[keep], labels[keep], class_logits[keep]
        ...
        return all_logits, all_boxes, all_scores, all_labels
    ...
    def forward(self,
        ...
        logits, boxes, scores, labels = self.postprocess_detections(class_logits, box_regression, proposals, image_shapes)
